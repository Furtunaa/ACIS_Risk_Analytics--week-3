...
This repository presents a marketing risk and predictive analytics project for AlphaCare Insurance Solutions (ACIS) in South Africa. It focuses on analyzing historical car insurance claims data from February 2014 to August 2015 to improve marketing strategies, detect low-risk customer groups that may qualify for reduced premiums, and develop a predictive pricing model.
